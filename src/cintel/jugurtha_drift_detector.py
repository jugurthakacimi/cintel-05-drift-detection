...
REFERENCE_FILE: Final[Path] = DATA_DIR / "reference_metrics_jugurtha.csv"
CURRENT_FILE: Final[Path] = DATA_DIR / "current_metrics_jugurtha.csv"

OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_jugurtha.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_jugurtha.csv"
